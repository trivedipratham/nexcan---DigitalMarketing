  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 pt-10">
        ...
        <section className="relative min-h-screen flex items-center justify-center pt-24 pb-20 px-6 md:px-12 lg:px-24 overflow-hidden">
          ...
          <div className="max-w-[1450px] w-full mx-auto relative z-20 flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-20">
            {/* ── LEFT: THE NARRATIVE ARC ── */}
            <div className="lg:w-[55%] space-y-12">
              <ScrollReveal delay={0.2}>
                <div className="relative">
                  <h1 className="text-[9vw] lg:text-[90px] font-display font-black tracking-tighter leading-[0.9] uppercase pr-10">
                    <span className="text-white block mb-2 underline underline-offset-[12px] decoration-yellow-400/20">
                      THE NEXCAN
                    </span>
                  ...
                  <div className="mt-8 flex items-center gap-4 opacity-50">
                    <span className="text-xs font-mono text-zinc-400 uppercase tracking-widest leading-none border border-zinc-800 px-3 py-1 rounded">
                      Modern Standard
                    </span>
              ...
              <ScrollReveal delay={0.4}>
                <div className="space-y-10">
                  <p className="text-lg md:text-xl text-zinc-300 font-body font-light max-w-lg leading-relaxed pr-8 border-l-2 border-yellow-400/30 pl-8">
                  ...
                  <div className="flex items-center gap-8 pt-4">
                    <div className="flex -space-x-4">
                      {[1, 2, 3, 4, 5].map((i) => (
                        <motion.div
                          ...
                          className="w-12 h-12 rounded-full border border-[#04060b] overflow-hidden bg-zinc-900 shadow-xl transition-all duration-300 relative group"
                        >
                          <img
                    ...
                    <div className="space-y-1 border-l border-white/5 pl-8">
                      <p className="text-white font-display text-lg font-black uppercase tracking-tighter leading-none">
                        10+ Dedicated Experts
                      </p>
                      <p className="text-zinc-400 font-mono text-[10px] uppercase tracking-[0.2em] font-bold">
                        Working Globally
                      </p>
                    </div>
                  </div>
            ...
            <div className="lg:w-[45%] flex justify-center items-center">
              <ScrollReveal delay={0.6}>
                <div className="relative w-full max-w-[500px] aspect-square group">
                  ...
                  {/* The Visual Engine */}
                  <div className=" bg-[#0d121f]/40 backdrop-blur-3xl border border-white/10 rounded-[3.5rem] relative overflow-hidden group shadow-[0_40px_100px_rgba(0,0,0,0.5)] z-20 transition-all duration-700 hover:border-yellow-400/20">
                    <img
                      src={about}
                      className="w-[500px] h-[500px] object-cover brightness-90 group-hover:scale-105 group-hover:brightness-100 transition-all duration-[1500ms]"
                  ...
                  {/* Integrated Metric Badges (Internalized) */}
                  <div className="absolute -top-6 -right-6 p-6 bg-zinc-900/90 backdrop-blur-xl border border-white/10 rounded-3xl z-30 shadow-2xl group-hover:-translate-y-2 transition-transform duration-500">
                    ...
                    <div className="text-white font-display text-2xl font-black tracking-tighter uppercase whitespace-nowrap">
                      ONLINE
                    </div>
                  </div>

                  <div className="absolute -bottom-6 -left-6 p-6 bg-[#04060b]/90 backdrop-blur-xl border border-white/5 rounded-3xl z-30 shadow-2xl flex items-center gap-4 group-hover:translate-y-2 transition-transform duration-500">
                    <span className="text-white font-display text-xl font-black">
                      EST. 2026
                    </span>
        ...
        <section className="py-48 px-6 md:px-12 lg:px-24">
          <div className="max-w-[1400px] w-full mx-auto grid grid-cols-1 lg:grid-cols-2 gap-24 lg:gap-32 items-center">
            <div className="relative group z-20">
              <ScrollReveal>
                ...
                <motion.div
                  whileHover={{ y: -10 }}
                  className="absolute -bottom-10 -left-10 bg-yellow-400 p-12 rounded-[3.5rem] shadow-2xl hidden md:block max-w-[340px] z-30"
                >
                  <h3 className="text-black font-display font-black text-4xl mb-4">
                    Our Mission
                  </h3>
                  <p className="text-black font-body text-base leading-relaxed font-bold">
            ...
            <div className="space-y-12 z-20 relative">
              <ScrollReveal>
                <div className="space-y-8">
                  <div className="inline-flex items-center gap-4 text-yellow-400 font-serif text-2xl tracking-wide">
                    <div className="w-16 h-px bg-yellow-400" />
                    <span>Who We Are</span>
                  </div>
                  <h2 className="text-6xl md:text-8xl lg:text-[100px] font-display font-black text-white tracking-tighter uppercase leading-[0.85] pr-10">
                    Creative <br />
                    In <span className="text-zinc-800">Spirit.</span>
                  </h2>
                  <div className="space-y-6 text-zinc-300 font-body text-xl font-light leading-relaxed max-w-xl">
                    <p>
        ...
        <section className="py-32 md:py-48 px-6 md:px-12 lg:px-24 relative overflow-hidden">
          ...
          <div className="max-w-[1500px] w-full mx-auto relative z-20">
            <div className="flex flex-col lg:flex-row items-end justify-between mb-24 gap-12">
              <ScrollReveal>
                <div className="relative">
                  <p className="text-yellow-400 font-mono text-xs uppercase tracking-[1em] font-black mb-6">
                    Our Core Values
                  </p>
                  <h2 className="text-[10vw] lg:text-[110px] font-display font-black text-white tracking-tighter leading-[0.85] uppercase pr-10">
                    WHAT WE <br />
              ...
              {values.map((val, i) => (
                ...
                >
                  <div className="relative group perspective-1000">
                    ...
                    <div className="relative p-12 rounded-[3.5rem] bg-white/[0.01] backdrop-blur-3xl border border-white/5 overflow-hidden transition-all duration-1000 group-hover:bg-white/[0.03] group-hover:border-white/10 group-hover:translate-y-[-8px] shadow-2xl">
                      ...
                      <div className="relative z-10 space-y-10">
                        <div className="flex justify-between items-start">
                          <div className="w-16 h-16 rounded-[2rem] bg-[#0d121f] border border-white/5 flex items-center justify-center text-yellow-400 group-hover:scale-110 group-hover:bg-yellow-400 group-hover:text-black transition-all duration-700 shadow-xl">
                            <val.icon size={28} />
                          </div>
                        ...
                        <div className="space-y-4">
                          <h3 className="text-3xl lg:text-4xl font-display font-black text-white tracking-tighter uppercase group-hover:text-yellow-400 transition-colors duration-500">
                            {val.title}
                          </h3>
                          <p className="text-zinc-300 font-body text-base leading-relaxed font-light max-w-sm group-hover:text-zinc-200 transition-colors duration-500">
                            {val.description}
                          </p>
                        </div>
        ...
        <section className="py-24 md:py-28 px-6 md:px-12 lg:px-24 bg-[#04060b] relative overflow-hidden border-y border-white/5">
              ...
              <div className="lg:col-span-4 space-y-12">
                <ScrollReveal>
                  <div className="space-y-6">
                    ...
                    <h2 className="text-7xl md:text-8xl font-display font-black text-white tracking-tighter leading-[0.85] uppercase pr-10">
                      THE <br />
                      <span className="text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 via-white to-white/40">
                        RECORD.
                      </span>
                    </h2>
                    <p className="text-xl text-zinc-300 font-body font-light leading-relaxed border-l-2 border-yellow-400/20 pl-8">
                  ...
                  {stats.map((stat, i) => (
                    <ScrollReveal key={i} delay={0.1 + i * 0.1}>
                      <div className="group relative">
                        ...
                        <div className="relative p-12 rounded-[4rem] bg-white/[0.02] border border-white/10 overflow-hidden transition-all duration-700 group-hover:bg-white/[0.04] group-hover:border-yellow-400/20 group-hover:-translate-y-2">
                          ...
                          <div className="relative z-10 space-y-10">
                            <div className="flex justify-between items-start">
                              <div className="w-14 h-14 rounded-2xl bg-black/40 border border-white/10 flex items-center justify-center text-yellow-400 group-hover:bg-yellow-400 group-hover:text-black transition-all duration-500 shadow-xl">
                                <stat.icon size={24} />
                              </div>
                            ...
                            <div className="space-y-4">
                              ...
                              <p
                                className={`text-7xl md:text-8xl font-display font-black tracking-tighter text-transparent bg-clip-text bg-gradient-to-r ${stat.color} leading-none`}
                              >
                                <ButterCounter
                                  value={stat.val}
                                  suffix={stat.suffix}
