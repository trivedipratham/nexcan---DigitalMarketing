      ...
      <div className="section-container relative z-10 px-6 lg:px-12">
        ...
        <div className="flex flex-col md:flex-row justify-between items-end gap-12 mb-24">
          <motion.div
            ...
            className="space-y-6"
          >
            <div className="flex items-center gap-3 text-yellow-400 font-mono text-xs uppercase tracking-[0.5em]">
              <Plus size={12} className="animate-spin-slow" /> Strategic Results
            </div>
            <h2 className="text-6xl md:text-8xl lg:text-9xl font-display font-bold text-white tracking-tighter uppercase leading-[0.8] pr-12">
              IMPACT <br />
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="md:text-right pb-2 max-w-sm"
          >
             <p className="text-zinc-300 font-body text-base mb-8 leading-relaxed">
               We don't just launch campaigns; we engineer financial breakthroughs for the world's most ambitious brands.
             </p>
              <Link to="/case-studies" className="group flex items-center gap-3 text-white font-mono text-xs uppercase tracking-[0.3em] md:ml-48">
          ...
          {cases.map((c, i) => (
            ...
            >
              ...
              <div className="w-full lg:w-[62%] relative group perspective-1000">
                <motion.div 
                  className="relative overflow-hidden rounded-[2.5rem] border border-white/10 shadow-3xl bg-zinc-900"
                >
                  <div className="absolute inset-0 bg-gradient-to-br from-white/10 to-transparent opacity-50 z-20 pointer-events-none" />
                  
                  {/* Image Wrap */}
                  <div className="h-[350px] md:h-[550px] lg:h-[600px] w-full overflow-hidden">
                     <img
                        src={c.image}
                        alt={c.industry}
                        loading="eager"
                  ...
                  <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-bl from-yellow-400/20 to-transparent z-20 pointer-events-none" />
                  
                  <div className="absolute bottom-10 right-10 z-30">
                     <div className="w-16 h-16 rounded-full bg-white/5 backdrop-blur-2xl border border-white/20 flex items-center justify-center text-white transition-all duration-500 shadow-2xl">
              ...
              <div className="w-full lg:w-[32%] relative">
                 <div className="bg-white/[0.02] backdrop-blur-3xl border border-white/10 p-10 md:p-14 rounded-[3rem] shadow-2xl relative overflow-hidden group/card min-h-[450px] flex flex-col justify-center">
                    ...
                    <div className="space-y-10 relative z-10">
                       <div className="space-y-4">
                          <div className="flex items-center gap-3">
                             ...
                             <span className="font-mono text-xs text-zinc-400 uppercase tracking-[0.4em]">{c.industry}</span>
                          </div>
                          <h3 className="text-4xl md:text-5xl lg:text-6xl font-display font-bold text-white tracking-tight leading-[1.1]">
                             {c.strategy}
                          </h3>
                       </div>

                       <div className="space-y-2">
                          <span className="text-zinc-400 font-mono text-[11px] uppercase tracking-[0.3em] block">Certified Performance</span>
                          <div className="relative overflow-visible">
                             <p className="text-6xl md:text-7xl lg:text-8xl font-display font-black text-transparent stroke-text tracking-tighter mb-4 pr-10">
                                {c.result}
                             </p>
                             <div className="flex items-center gap-4">
                                <p className="text-xl md:text-2xl font-display font-bold text-yellow-400 tracking-tight">
                                   {c.metric}
                                </p>
