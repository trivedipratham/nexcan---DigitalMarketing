...
const testimonials = [
  {
    quote: "Nexus Digital transformed our online presence. The ROI from their campaigns exceeded every projection we had.",
    name: "Sarah Chen",
    role: "CMO, TechVault",
    result: "+340% revenue growth",
  },
  {
    quote: "Their data-driven approach is genuinely different. They don't guess — they know exactly what levers to pull.",
    name: "Marcus Rivera",
    role: "Founder, ScaleUp Labs",
    result: "5X lead generation",
  },
  {
    quote: "We've worked with agencies before, but none operated with this level of precision and transparency.",
    name: "Emily Nakamura",
            ...
            >
              ...
              <div className="border-t border-border pt-6">
                <div className="flex items-center gap-4">
                  <div className="w-10 h-10 rounded-full bg-gradient-to-br from-neon-violet to-neon-blue flex items-center justify-center font-display font-bold text-sm text-foreground">
                    {t.name[0]}
                  </div>
                  <div>
