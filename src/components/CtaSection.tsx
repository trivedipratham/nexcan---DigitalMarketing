    ...
    <section className="py-20 md:py-24 bg-[#0B0F19] relative overflow-hidden border-t border-white/5">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden text-center flex items-center justify-center">
        ...
        <div className="absolute rotate-[-5deg] opacity-[0.01]">
          <span className="text-[25vw] font-display font-black text-white tracking-tighter leading-none select-none uppercase">
            GROW
          </span>
        </div>
      ...
      <div className="section-container relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <h2 className="text-5xl md:text-7xl font-display font-bold text-white tracking-tighter uppercase leading-[0.95] mb-6">
              Ready to <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 via-white to-yellow-600">Grow?</span>
            </h2>

            <p className="text-zinc-500 font-body text-base md:text-lg max-w-lg mx-auto leading-relaxed mb-10">
            ...
            <div className="relative group/btn">
              ...
              <Link
                to="/contact"
                className="relative inline-flex items-center gap-4 bg-white text-black px-10 py-5 rounded-full font-display font-black text-[12px] tracking-[0.2em] uppercase overflow-hidden hover:bg-yellow-400 transition-all duration-500 group"
              >
